	...
	var PicCarousel = (function() {
		...
		PicCarousel.prototype = {
			...
			init: function() {
				...
				me.posterItemMain = me.poster.find(".poster-list");
				me.nextBtn = me.poster.find(".poster-next-btn");
				me.prevBtn = me.poster.find(".poster-prev-btn");
				me.posterItems = me.poster.find(".poster-item");
