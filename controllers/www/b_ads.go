 ...
 * @return {*}
 */
func (this *BaseController) AdsPaginate(page, limit int, site_id int64, site_flag string, category_id int64, call_index string) ([]*bizmodel.ApiAdsListModel, int64, error) {
