...
// https://github.com/lzyzsd/wechat-2/blob/master/client/token_cache_service.png
// 参考，暂无使用
...
var (
	_ TokenCache   = new(defaultTokenCacheService)
	_ TokenService = new(defaultTokenCacheService)
)
