...
type ApiTagModel struct {
	TagID          int64  `gorm:"column:tag_id;type:bigint;" json:"tag_id" form:"tag_id"`                                  // 标签ID
	...
	Name           string `gorm:"column:name;type:varchar(64);" json:"name" form:"name"`                                   // 标签名称
	Title          string `gorm:"column:title;type:varchar(128);" json:"title" form:"title"`                               // 标签标题
	...
	Template       string `gorm:"column:template;type:varchar(64);" json:"template" form:"template"`                       // 模板
