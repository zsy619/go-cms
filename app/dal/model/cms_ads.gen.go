...
type CmsAds struct {
	AdsID      int64     `gorm:"column:ads_id;type:bigint;primaryKey;autoIncrement:true;comment:主键" json:"ads_id" form:"ads_id"`                // 主键
	...
	BeginTime  time.Time `gorm:"column:begin_time;type:datetime;default:CURRENT_TIMESTAMP;comment:开始时间" json:"begin_time" form:"begin_time"`    // 开始时间
	EndTime    time.Time `gorm:"column:end_time;type:datetime;default:CURRENT_TIMESTAMP;comment:结束时间" json:"end_time" form:"end_time"`          // 结束时间
