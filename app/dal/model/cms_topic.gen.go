...
type CmsTopic struct {
	TopicID        int64     `gorm:"column:topic_id;type:bigint;primaryKey;autoIncrement:true;comment:专题ID" json:"topic_id" form:"topic_id"`        // 专题ID
	...
	Name           string    `gorm:"column:name;type:varchar(64);comment:专题名称" json:"name" form:"name"`                                             // 专题名称
	Title          string    `gorm:"column:title;type:varchar(128);comment:专题标题" json:"title" form:"title"`                                         // 专题标题
