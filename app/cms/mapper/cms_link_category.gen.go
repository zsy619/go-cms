...
func newCmsLinkCategory(db *gorm.DB, opts ...gen.DOOption) cmsLinkCategory {
	...
	_cmsLinkCategory.cmsLinkCategoryDo.UseModel(&domain.CmsLinkCategory{})
...
func (c cmsLinkCategoryDo) CreateInBatches(values []*domain.CmsLinkCategory, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c cmsLinkCategoryDo) Save(values ...*domain.CmsLinkCategory) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cmsLinkCategoryDo) First() (*domain.CmsLinkCategory, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*domain.CmsLinkCategory), nil
	}
}

func (c cmsLinkCategoryDo) Take() (*domain.CmsLinkCategory, error) {
...
func (c cmsLinkCategoryDo) Last() (*domain.CmsLinkCategory, error) {
...
func (c cmsLinkCategoryDo) Find() ([]*domain.CmsLinkCategory, error) {
	result, err := c.DO.Find()
	return result.([]*domain.CmsLinkCategory), err
}

func (c cmsLinkCategoryDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.CmsLinkCategory, err error) {
	buf := make([]*domain.CmsLinkCategory, 0, batchSize)
...
func (c cmsLinkCategoryDo) FindInBatches(result *[]*domain.CmsLinkCategory, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c cmsLinkCategoryDo) FirstOrInit() (*domain.CmsLinkCategory, error) {
...
func (c cmsLinkCategoryDo) FirstOrCreate() (*domain.CmsLinkCategory, error) {
...
func (c cmsLinkCategoryDo) FindByPage(offset int, limit int) (result []*domain.CmsLinkCategory, count int64, err error) {
...
func (c cmsLinkCategoryDo) Delete(models ...*domain.CmsLinkCategory) (result gen.ResultInfo, err error) {
