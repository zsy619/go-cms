...
func newCmsLink(db *gorm.DB, opts ...gen.DOOption) cmsLink {
	...
	_cmsLink.cmsLinkDo.UseModel(&domain.CmsLink{})
...
func (c cmsLinkDo) CreateInBatches(values []*domain.CmsLink, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c cmsLinkDo) Save(values ...*domain.CmsLink) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cmsLinkDo) First() (*domain.CmsLink, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*domain.CmsLink), nil
	}
}

func (c cmsLinkDo) Take() (*domain.CmsLink, error) {
...
func (c cmsLinkDo) Last() (*domain.CmsLink, error) {
...
func (c cmsLinkDo) Find() ([]*domain.CmsLink, error) {
	result, err := c.DO.Find()
	return result.([]*domain.CmsLink), err
}

func (c cmsLinkDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.CmsLink, err error) {
	buf := make([]*domain.CmsLink, 0, batchSize)
...
func (c cmsLinkDo) FindInBatches(result *[]*domain.CmsLink, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c cmsLinkDo) FirstOrInit() (*domain.CmsLink, error) {
...
func (c cmsLinkDo) FirstOrCreate() (*domain.CmsLink, error) {
...
func (c cmsLinkDo) FindByPage(offset int, limit int) (result []*domain.CmsLink, count int64, err error) {
...
func (c cmsLinkDo) Delete(models ...*domain.CmsLink) (result gen.ResultInfo, err error) {
