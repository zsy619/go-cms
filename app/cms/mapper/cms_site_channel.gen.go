...
func newCmsSiteChannel(db *gorm.DB, opts ...gen.DOOption) cmsSiteChannel {
	...
	_cmsSiteChannel.cmsSiteChannelDo.UseModel(&domain.CmsSiteChannel{})
...
func (c cmsSiteChannelDo) CreateInBatches(values []*domain.CmsSiteChannel, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c cmsSiteChannelDo) Save(values ...*domain.CmsSiteChannel) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cmsSiteChannelDo) First() (*domain.CmsSiteChannel, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*domain.CmsSiteChannel), nil
	}
}

func (c cmsSiteChannelDo) Take() (*domain.CmsSiteChannel, error) {
...
func (c cmsSiteChannelDo) Last() (*domain.CmsSiteChannel, error) {
...
func (c cmsSiteChannelDo) Find() ([]*domain.CmsSiteChannel, error) {
	result, err := c.DO.Find()
	return result.([]*domain.CmsSiteChannel), err
}

func (c cmsSiteChannelDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.CmsSiteChannel, err error) {
	buf := make([]*domain.CmsSiteChannel, 0, batchSize)
...
func (c cmsSiteChannelDo) FindInBatches(result *[]*domain.CmsSiteChannel, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c cmsSiteChannelDo) FirstOrInit() (*domain.CmsSiteChannel, error) {
...
func (c cmsSiteChannelDo) FirstOrCreate() (*domain.CmsSiteChannel, error) {
...
func (c cmsSiteChannelDo) FindByPage(offset int, limit int) (result []*domain.CmsSiteChannel, count int64, err error) {
...
func (c cmsSiteChannelDo) Delete(models ...*domain.CmsSiteChannel) (result gen.ResultInfo, err error) {
