...
// AttachPaginate 获取
func (svc *CmsAttach) AttachPaginate(page, limit int, tableName string, recordId int64, typeId int32, adminId int64, roleType string) ([]*domain.CmsAttach, int64, error) {
	mdl, do := mapper.CmsAttachDo()
...
// AttachSave 保存或更新
func (svc *CmsAttach) AttachSave(input *domain.CmsAttach) error {
	mdl, do := mapper.CmsAttachDo()
	var err error
