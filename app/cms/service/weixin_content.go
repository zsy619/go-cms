...
// ContentPaginate 分页
func (svc *WeixinContent) ContentPaginate(page, limit int, accountId int64) ([]*service_model.Weixin_ContentModel, int64, error) {
	_, do := mapper.WeixinResponseContentDo()
	...
	list := []*service_model.Weixin_ContentModel{}
	count := int64(0)
