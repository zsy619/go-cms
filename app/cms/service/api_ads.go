...
func (svc *ApiAds) get(cackeKeyPrefix string, limit int, site_id int64, site_flag string, category_id int64, call_index string) ([]*service_model.ApiAdsModel, int64, error) {
	...
	if found, item := lib.AdsCache.Get(cacheKey); found {
		list := item.([]*service_model.ApiAdsModel)
		logs.Debug("AdsList[Cache]::", "cacheKey", cacheKey, "AdsList", list)
		return list, int64(len(list)), nil
	}
	list := []*service_model.ApiAdsModel{}

	_, do := mapper.CmsAdsDo()
...
* @return {*}
 */
func (svc *ApiAds) Get(limit int, site_id int64, site_flag string, category_id int64, call_index string) ([]*service_model.ApiAdsModel, int64, error) {
...
* @return {*}
 */
func (svc *ApiAds) GetNew(limit int, site_id int64, site_flag string, category_id int64, call_index string) ([]*service_model.ApiAdsModel, int64, error) {
 ...
 * @return {*}
 */
func (svc *ApiAds) Paginate(page, limit int, site_id int64, site_flag string, category_id int64, call_index string) ([]*service_model.ApiAdsModel, int64, error) {
	list := []*service_model.ApiAdsModel{}
